...
//         // Set exit code to 0 if run has no failed test cases
//         if (!runHasFailedCases && process.exitCode != 0){
//           console.log(`All tests in run are passed, going to override current exit code with 0`);
//           process.exit(0);
//         }
